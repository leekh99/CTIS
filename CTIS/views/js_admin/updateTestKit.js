const elements = {
    ...
    testDetails : document.getElementById('testKitDetails'),
    testSuccess : document.getElementById('testKitDetails-success'),
    testError : document.getElementById('testKitDetails-fail')
}
